...
!function(t, e) {
    ...
    function b(t, e) {
        for (var i, n, s = [], o = 0, a = t.length; o < a; o++)
            n = t[o],
            n.style && (i = n.style.display, e ? ("none" === i && (s[o] = Nt.get(n, "display") || null, s[o] || (n.style.display = "")), "" === n.style.display && Rt(n) && (s[o] = g(n))) : "none" !== i && (s[o] = "none", Nt.set(n, "display", i)));
        for (o = 0; o < a; o++)
    ...
    function _(t, e) {
        for (var i = 0, n = t.length; i < n; i++)
            Nt.set(t[i], "globalEval", !e || Nt.get(e[i], "globalEval"))
    }
        ...
        for (var o, a, r, l, c, h, u = e.createDocumentFragment(), d = [], p = 0, f = t.length; p < f; p++)
            if ((o = t[p]) || 0 === o)
                if ("object" === mt.type(o))
                    ...
                    for (a = a || u.appendChild(e.createElement("div")), r = (Yt.exec(o) || ["", ""])[1].toLowerCase(), l = Vt[r] || Vt._default, a.innerHTML = l[1] + mt.htmlPrefilter(o) + l[2], h = l[0]; h--;)
                        a = a.lastChild;
                    mt.merge(d, a.childNodes),
                    a = u.firstChild,
                    a.textContent = ""
                } else
    ...
    function S(t, e, n, s) {
        ...
        var o,
            ...
            f = e[0],
            m = mt.isFunction(f);
        if (m || d > 1 && "string" == typeof f && !pt.checkClone && ie.test(f))
        ...
        if (d && (o = y(e, t[0].ownerDocument, !1, t, s), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || s)) {
            for (r = mt.map(v(o, "script"), T), l = r.length; u < d; u++)
                c = o,
                u !== p && (c = mt.clone(c, !0, !0), l && mt.merge(r, v(c, "script"))),
                n.call(t[u], c, u);
            if (l)
                for (h = r[r.length - 1].ownerDocument, mt.map(r, M), u = 0; u < l; u++)
                    c = r[u],
                    Kt.test(c.type || "") && !Nt.access(c, "globalEval") && mt.contains(h, c) && (c.src ? mt._evalUrl && mt._evalUrl(c.src) : i(c.textContent.replace(se, ""), h))
        }
        return t
    }
    function j(t, e, i) {
        for (var n, s = e ? mt.filter(e, t) : t, o = 0; null != (n = s[o]); o++)
            i || 1 !== n.nodeType || mt.cleanData(v(n)),
            n.parentNode && (i && mt.contains(n.ownerDocument, n) && _(v(n, "script")), n.parentNode.removeChild(n));
        return t
    }
    function A(t, e, i) {
        var n,
    ...
    function L(t, e, i, n, s) {
        ...
        for (o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0; o < 4; o += 2)
            "margin" === i && (a += mt.css(t, i + Wt[o], !0, s)),
            n ? ("content" === i && (a -= mt.css(t, "padding" + Wt[o], !0, s)), "margin" !== i && (a -= mt.css(t, "border" + Wt[o] + "Width", !0, s))) : (a += mt.css(t, "padding" + Wt[o], !0, s), "padding" !== i && (a += mt.css(t, "border" + Wt[o] + "Width", !0, s)));
        return a
    }
    function $(t, e, i) {
        var n,
    ...
    function B(t, e, i) {
        ...
        if ((l = !mt.isEmptyObject(e)) || !mt.isEmptyObject(p)) {
            ...
            l = !1;
            for (n in p)
                l || (g ? "hidden" in g && (m = g.hidden) : g = Nt.access(t, "fxshow", {
                    display: c
    ...
    function Y(t, e, i) {
        var n,
            ...
            l = function() {
                if (s)
                    return !1;
                for (var e = fe || W(), i = Math.max(0, c.startTime + c.duration - e), n = i / c.duration || 0, o = 1 - n, a = 0, l = c.tweens.length; a < l; a++)
                    c.tweens[a].run(o);
        ...
        for ("boolean" == typeof a && (c = a, a = arguments[r] || {}, r++), "object" == typeof a || mt.isFunction(a) || (a = {}), r === l && (a = this, r--); r < l; r++)
            if (null != (t = arguments[r]))
                for (e in t)
                    i = a[e],
                    n = t[e],
                    a !== n && (c && n && (mt.isPlainObject(n) || (s = Array.isArray(n))) ? (s ? (s = !1, o = i && Array.isArray(i) ? i : []) : o = i && mt.isPlainObject(i) ? i : {}, a[e] = mt.extend(c, o, n)) : void 0 !== n && (a[e] = n));
        return a
    },
    mt.extend({
    ...
    var yt = function(t) {
            ...
            if (!n && ((e ? e.ownerDocument || e : z) !== j && S(e), e = e || j, E)) {
                if (11 !== f && (l = mt.exec(t)))
                    if (s = l[1]) {
                        if (9 === f) {
                            ...
                            if (a.id === s)
                                return i.push(a), i
                        } else if (p && (a = p.getElementById(s)) && L(e, a) && a.id === s)
                            return i.push(a), i
                    } else {
                        if (l[2])
                            return G.apply(i, e.getElementsByTagName(t)), i;
                        if ((s = l[3]) && y.getElementsByClassName && e.getElementsByClassName)
                            return G.apply(i, e.getElementsByClassName(s)), i
                    }
                if (y.qsa && !B[t + " "] && (!O || !O.test(t))) {
                    if (1 !== f)
                        ...
                        for ((r = e.getAttribute("id")) ? r = r.replace(_t, yt) : e.setAttribute("id", r = $), h = C(t), o = h.length; o--;)
                            h[o] = "#" + r + " " + u(h[o]);
                        d = h.join(","),
        ...
        function d(t, e, i) {
            ...
            return e.first ? function(e, i, s) {
                ...
                if (l) {
                    ...
                    for (; e = e[n];)
                        if (1 === e.nodeType || a)
                            if (u = e[$] || (e[$] = {}), h = u[e.uniqueID] || (u[e.uniqueID] = {}), s && s === e.nodeName.toLowerCase())
                                e = e[n] || e;
                            else {
                                if ((c = h[o]) && c[0] === F && c[1] === r)
                                    return d[2] = c[2];
        ...
        function g(t, e, i, s, o, a) {
            return s && !s[$] && (s = g(s)), o && !o[$] && (o = g(o, a)), n(function(n, a, r, l) {
                var c,
                    ...
                    _ = i ? o || (n ? t : g || s) ? [] : a : v;
                if (i && i(v, _, r, l), s)
                    for (c = m(_, p), s(c, [], r, l), h = c.length; h--;)
                        (u = c[h]) && (_[p[h]] = !(v[p[h]] = u));
                if (n) {
                    if (o || t) {
                        if (o) {
                        ...
                        for (h = _.length; h--;)
                            (u = _[h]) && (c = o ? Z(n, u) : d[h]) > -1 && (n[c] = !(a[c] = u))
                    }
                } else
                    _ = m(_ === a ? _.splice(g, _.length) : _),
                    o ? o(null, a, _, l) : G.apply(a, _)
            })
        }
        function b(t) {
                ...
                a = function(n, a, r, l, c) {
                    ...
                    if (p += f, s && f !== p) {
                        ...
                        if (n) {
                            if (p > 0)
                                for (; f--;)
                                    g[f] || b[f] || (b[f] = V.call(l));
                            b = m(b)
                        }
                        G.apply(l, b),
                        c && !n && b.length > 0 && p + i.length > 1 && e.uniqueSort(l)
                    }
                    return c && (F = y, M = v), g
                };
            return s ? n(a) : a
        ...
        try {
            G.apply(K = Q.call(z.childNodes), z.childNodes),
        ...
        S = e.setDocument = function(t) {
            ...
            return n !== j && 9 === n.nodeType && n.documentElement ? (j = n, A = j.documentElement, E = !k(j), z !== j && (i = j.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", wt, !1) : i.attachEvent && i.attachEvent("onunload", wt)), y.attributes = s(function(t) {
                ...
                A.appendChild(t).innerHTML = "<a id='" + $ + "'></a><select id='" + $ + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                t.querySelectorAll("[msallowcapture^='']").length && O.push("[*^$]=" + tt + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || O.push("\\[" + tt + "*(?:value|" + J + ")"),
                t.querySelectorAll("[id~=" + $ + "-]").length || O.push("~="),
                t.querySelectorAll(":checked").length || O.push(":checked"),
                t.querySelectorAll("a#" + $ + "+*").length || O.push(".#.+[+~]")
            }), s(function(t) {
                ...
                var i,
                    ...
                    l = [e];
                if (!s || !o)
                    return t === j ? -1 : e === j ? 1 : s ? -1 : o ? 1 : I ? Z(I, t) - Z(I, e) : 0;
                if (s === o)
                    return a(t, e);
        ...
        e.matchesSelector = function(t, i) {
            if ((t.ownerDocument || t) !== j && S(t), i = i.replace(lt, "='$1']"), y.matchesSelector && E && !B[i + " "] && (!N || !N.test(i)) && (!O || !O.test(i)))
                try {
                    var n = H.call(t, i);
                    ...
                    return 1 === n && 0 === s ? function(t) {
                        ...
                        if (g) {
                            if (o) {
                                for (; m;) {
                                    for (d = e; d = d[m];)
                                        if (r ? d.nodeName.toLowerCase() === b : 1 === d.nodeType)
                                            return !1;
                            ...
                            if (f = [a ? g.firstChild : g.lastChild], a && v) {
                                ...
                                for (; (d = ++p && d && d[m] || (_ = p = 0) || f.pop()) && ((r ? d.nodeName.toLowerCase() !== b : 1 !== d.nodeType) || !++_ || (v && (u = d[$] || (d[$] = {}), h = u[d.uniqueID] || (u[d.uniqueID] = {}), h[t] = [F, _]), d !== e));)
                                    ;
        ...
        return h.prototype = w.filters = w.pseudos, w.setFilters = new h, C = e.tokenize = function(t, i) {
            ...
            for (r = t, l = [], c = w.preFilter; r;) {
                ...
                n = !1,
                (s = rt.exec(r)) && (n = s.shift(), o.push({
                    value: n,
                    type: s[0].replace(ot, " ")
                }), r = r.slice(n.length));
                for (a in w.filter)
                    !(s = ut[a].exec(r)) || c[a] && !(s = c[a](s)) || (n = s.shift(), o.push({
                        value: n,
                        type: a,
                        matches: s
                    }), r = r.slice(n.length));
            ...
            if (i = i || [], 1 === d.length) {
                if (o = d[0] = d[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && 9 === e.nodeType && E && w.relative[o[1].type]) {
                    if (!(e = (w.find.ID(a.matches[0].replace(bt, vt), e) || [])[0]))
                        return i;
                    h && (e = e.parentNode),
                ...
                for (s = ut.needsContext.test(t) ? 0 : o.length; s-- && (a = o[s], !w.relative[r = a.type]);)
                    if ((l = w.find[r]) && (n = l(a.matches[0].replace(bt, vt), gt.test(o[0].type) && c(e.parentNode) || e))) {
                        if (o.splice(s, 1), !(t = n.length && u(o)))
    ...
    mt.find = yt,
    mt.expr = yt.selectors,
    mt.expr[":"] = mt.expr.pseudos,
    mt.uniqueSort = mt.unique = yt.uniqueSort,
    mt.text = yt.getText,
    mt.isXMLDoc = yt.isXML,
    mt.contains = yt.contains,
    mt.escapeSelector = yt.escape;
    ...
    (mt.fn.init = function(t, e, i) {
        ...
        if (i = i || Tt, "string" == typeof t) {
            if (!(n = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : Mt.exec(t)) || !n[1] && e)
                                ...
                                var r = this,
                                    ...
                                    u = function() {
                                        var t,
                                            u;
                                        if (!(e < a)) {
                                            if ((t = n.apply(r, h)) === i.promise())
                                                throw new TypeError("Thenable self-resolution");
                                            u = t && ("object" == typeof t || "function" == typeof t) && t.then,
                                            mt.isFunction(u) ? s ? u.call(t, o(a, i, l, s), o(a, i, c, s)) : (a++, u.call(t, o(a, i, l, s), o(a, i, c, s), o(a, i, l, i.notifyWith))) : (n !== l && (r = void 0, h = [t]), (s || i.resolveWith)(r, h))
                                        }
                                    },
                                    d = s ? u : function() {
                                        try {
                                            ...
                                            e + 1 >= a && (n !== c && (r = void 0, h = [t]), i.rejectWith(r, h))
                                        }
                                    };
    ...
    d.prototype = {
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== n) {
                if (void 0 !== e) {
                    Array.isArray(e) ? e = e.map(mt.camelCase) : (e = mt.camelCase(e), e = e in n ? [e] : e.match(St) || []),
                    i = e.length;
                    for (; i--;)
                        delete n[e[i]]
                }
        ...
        data: function(t, e) {
            ...
            if (void 0 === t) {
                if (this.length && (s = Ht.get(o), 1 === o.nodeType && !Nt.get(o, "hasDataAttrs"))) {
                    for (i = a.length; i--;)
                        a[i] && (n = a[i].name, 0 === n.indexOf("data-") && (n = mt.camelCase(n.slice(5)), f(o, n, s[n])));
    ...
    mt.extend({
        queue: function(t, e, i) {
            var n;
            if (t)
                return e = (e || "fx") + "queue", n = Nt.get(t, e), i && (!n || Array.isArray(i) ? n = Nt.access(t, e, mt.makeArray(i)) : n.push(i)), n || []
        },
    ...
    mt.fn.extend({
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; a--;)
                (i = Nt.get(o[a], t + "queueHooks")) && i.empty && (n++, i.empty.add(r));
    ...
    mt.event = {
        ...
        add: function(t, e, i, n, s) {
            ...
            if (g)
                for (i.handler && (o = i, i = o.handler, s = o.selector), s && mt.find.matchesSelector(Gt, s), i.guid || (i.guid = mt.guid++), (l = g.events) || (l = g.events = {}), (a = g.handle) || (a = g.handle = function(e) {
                    ...
                    p = m = r[1],
                    f = (r[2] || "").split(".").sort(),
                    p && (u = mt.event.special[p] || {}, p = (s ? u.delegateType : u.bindType) || p, u = mt.event.special[p] || {}, h = mt.extend({
                        type: p,
                        origType: m,
                        data: n,
                        handler: i,
            ...
            if (g && (l = g.events)) {
                for (e = (e || "").match(St) || [""], c = e.length; c--;)
                    if (r = Jt.exec(e[c]) || [], p = m = r[1], f = (r[2] || "").split(".").sort(), p) {
                        for (u = mt.event.special[p] || {}, p = (n ? u.delegateType : u.bindType) || p, d = l[p] || [], r = r[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = d.length; o--;)
                            h = d[o],
                            !s && m !== h.origType || i && i.guid !== h.guid || r && !r.test(h.namespace) || n && n !== h.selector && ("**" !== n || !h.selector) || (d.splice(o, 1), h.selector && d.delegateCount--, u.remove && u.remove.call(t, h));
        ...
        dispatch: function(t) {
            ...
            if (r.delegateTarget = this, !h.preDispatch || !1 !== h.preDispatch.call(this, r)) {
                for (a = mt.event.handlers.call(this, r, c), e = 0; (s = a[e++]) && !r.isPropagationStopped();)
                    for (r.currentTarget = s.elem, i = 0; (o = s.handlers[i++]) && !r.isImmediatePropagationStopped();)
                        r.rnamespace && !r.rnamespace.test(o.namespace) || (r.handleObj = o, r.data = o.data, void 0 !== (n = ((mt.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, l)) && !1 === (r.result = n) && (r.preventDefault(), r.stopPropagation()));
                ...
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                        for (o = [], a = {}, i = 0; i < l; i++)
                            n = e[i],
                            s = n.selector + " ",
                            void 0 === a[s] && (a[s] = n.needsContext ? mt(s, this).index(c) > -1 : mt.find(s, this, null, [c]).length),
                            a[s] && o.push(n);
                        o.length && r.push({
                            elem: c,
                            handlers: o
    ...
    mt.extend({
        ...
        clone: function(t, e, i) {
            ...
            if (!(pt.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || mt.isXMLDoc(t)))
                for (a = v(r), o = v(t), n = 0, s = o.length; n < s; n++)
                    P(o[n], a[n]);
            if (e)
                if (i)
                    for (o = o || v(t), a = a || v(r), n = 0, s = o.length; n < s; n++)
                        I(o[n], a[n]);
                else
                    I(t, r);
    ...
    mt.each({
        ...
        mt.fn[t] = function(t) {
            for (var i, n = [], s = mt(t), o = s.length - 1, a = 0; a <= o; a++)
    ...
    mt.each(["height", "width"], function(t, e) {
        mt.cssHooks[e] = {
            get: function(t, i, n) {
                if (i)
                    return !le.test(mt.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? $(t, e, n) : qt(t, he, function() {
                        return $(t, e, n)
                    })
            },
            set: function(t, i, n) {
    ...
    mt.cssHooks.marginLeft = E(pt.reliableMarginLeft, function(t, e) {
        if (e)
            return (parseFloat(A(t, "marginLeft")) || t.getBoundingClientRect().left - qt(t, {
                marginLeft: 0
            }, function() {
        ...
        css: function(t, e) {
            return Et(this, function(t, e, i) {
                var n,
                    ...
                    a = 0;
                if (Array.isArray(e)) {
                    for (n = re(t), s = e.length; a < s; a++)
                        o[e[a]] = mt.css(t, e[a], !1, n);
                    return o
                }
    ...
    mt.extend({
        attr: function(t, e, i) {
            var n,
                ...
                o = t.nodeType;
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === t.getAttribute ? mt.prop(t, e, i) : (1 === o && mt.isXMLDoc(t) || (s = mt.attrHooks[e.toLowerCase()] || (mt.expr.match.bool.test(e) ? ve : void 0)), void 0 !== i ? null === i ? void mt.removeAttr(t, e) : s && "set" in s && void 0 !== (n = s.set(t, i, e)) ? n : (t.setAttribute(e, i + ""), i) : s && "get" in s && null !== (n = s.get(t, e)) ? n : (n = mt.find.attr(t, e), null == n ? void 0 : n))
        },
        attrHooks: {
            type: {
                set: function(t, e) {
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : mt.isFunction(t) ? this.each(function(i) {
                ...
                var e,
                    ...
                    o;
                if ("string" === i)
                    for (n = 0, s = mt(this), o = t.match(St) || []; e = o[n++];)
                        s.hasClass(e) ? s.removeClass(e) : s.addClass(e);
                else
                    void 0 !== t && "boolean" !== i || (e = V(this), e && Nt.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Nt.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e,
                ...
                n = 0;
            for (e = " " + t + " "; i = this[n++];)
                if (1 === i.nodeType && (" " + K(V(i)) + " ").indexOf(e) > -1)
                    return !0;
            return !1
        }
    });
    ...
    mt.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var i, n, s = t.options, o = mt.makeArray(e), a = s.length; a--;)
                        n = s[a],
        ...
        trigger: function(e, i, n, s) {
            ...
            if (a = r = n = n || it, 3 !== n.nodeType && 8 !== n.nodeType && !ke.test(p + mt.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), c = p.indexOf(":") < 0 && "on" + p, e = e[mt.expando] ? e : new mt.Event(p, "object" == typeof e && e), e.isTrigger = s ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : mt.makeArray(i, [e]), u = mt.event.special[p] || {}, s || !u.trigger || !1 !== u.trigger.apply(n, i))) {
                if (!s && !u.noBubble && !mt.isWindow(n)) {
                    for (l = u.delegateType || p, ke.test(l + p) || (a = a.parentNode); a; a = a.parentNode)
                        d.push(a),
                        r = a;
                ...
                for (o = 0; (a = d[o++]) && !e.isPropagationStopped();)
                    ...
                    h = (Nt.get(a, "events") || {})[e.type] && Nt.get(a, "handle"),
                    h && h.apply(a, i),
                    (h = c && a[c]) && h.apply && Ot(a) && (e.result = h.apply(a, i), !1 === e.result && e.preventDefault());
        ...
        ajax: function(e, i) {
            ...
            if (b.promise(k), f.url = ((e || f.url || Ce.href) + "").replace(Le, Ce.protocol + "//"), f.type = i.method || i.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(St) || [""], null == f.crossDomain) {
                ...
                try {
                    c.href = f.url,
                    c.href = c.href,
                    f.crossDomain = We.protocol + "//" + We.host != c.protocol + "//" + c.host
                } catch (t) {
                    f.crossDomain = !0
                }
            }
            ...
            o = f.url.replace(Ae, ""),
            f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(je, "+")) : (p = f.url.slice(o.length), f.data && (o += (Te.test(o) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (o = o.replace(Ee, "$1"), p = (Te.test(o) ? "&" : "?") + "_=" + De++ + p), f.url = o + p),
            f.ifModified && (mt.lastModified[o] && k.setRequestHeader("If-Modified-Since", mt.lastModified[o]), mt.etag[o] && k.setRequestHeader("If-None-Match", mt.etag[o])),
            (f.data && f.hasContent && !1 !== f.contentType || i.contentType) && k.setRequestHeader("Content-Type", f.contentType),
            k.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Fe + "; q=0.01" : "") : f.accepts["*"]);
            for (d in f.headers)
                k.setRequestHeader(d, f.headers[d]);
            if (f.beforeSend && (!1 === f.beforeSend.call(m, k, f) || h))
                return k.abort();
            if (x = "abort", v.add(f.complete), k.done(f.success), k.fail(f.error), s = Q(ze, f, i, k)) {
                if (k.readyState = 1, u && g.trigger("ajaxSend", [k, f]), h)
                    return k;
    ...
    pt.cors = !!qe && "withCredentials" in qe,
    pt.ajax = qe = !!qe,
    mt.ajaxTransport(function(e) {
        var i,
            n;
        if (pt.cors || qe && !e.crossDomain)
            return {
                send: function(s, o) {
                    var a,
                        r = e.xhr();
    ...
    mt.ajaxPrefilter("json jsonp", function(e, i, n) {
        ...
        if (r || "jsonp" === e.dataTypes[0])
            return s = e.jsonpCallback = mt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, r ? e[r] = e[r].replace(Ue, "$1" + s) : !1 !== e.jsonp && (e.url += (Te.test(e.url) ? "&" : "?") + e.jsonp + "=" + s), e.converters["script json"] = function() {
    ...
    mt.offset = {
        setOffset: function(t, e, i) {
            ...
            c ? (n = u.position(), a = n.top, s = n.left) : (a = parseFloat(o) || 0, s = parseFloat(l) || 0),
            mt.isFunction(e) && (e = e.call(t, i, mt.extend({}, r))),
    ...
    mt.each(["top", "left"], function(t, e) {
        mt.cssHooks[e] = E(pt.pixelPosition, function(t, i) {
            if (i)
                return i = A(t, e), ae.test(i) ? mt(t).position()[e] + "px" : i
        })
    }),
    mt.each({
        Height: "height",
...
function(t) {
    ...
    function() {
        ...
        t.fn.position = function(s) {
            ...
            return b = n(v), v[0].preventDefault && (s.at = "left top"), p = b.width, f = b.height, m = b.offset, g = t.extend({}, m), t.each(["my", "at"], function() {
                ...
                "bottom" === s.my[1] ? D.top -= h : "center" === s.my[1] && (D.top -= h / 2),
                D.left += T[0],
                D.top += T[1],
                n = {
                    marginLeft: d,
                ...
                s.using && (r = function(t) {
                    ...
                    c > p && p > a(e + i) && (u.horizontal = "center"),
                    h > f && f > a(n + r) && (u.vertical = "middle"),
                    u.important = o(a(e), a(i)) > o(a(n), a(r)) ? "horizontal" : "vertical",
    ...
    function(t, e) {
        ...
        p(c, function(n, s) {
            var o = s.props,
                ...
                h = s.from;
            l.fn[n] = function(n) {
                if (c && !this[r] && (this[r] = c(this._rgba)), n === e)
                    return this[r].slice();
                var s,
                    a = t.type(n),
        ...
        t.fn.extend({
            effect: function() {
                function i(e) {
                    ...
                    var r = t(this);
                    n.mode = h.shift(),
                    !1 === t.uiBackCompat || o ? "none" === n.mode ? (r[c](), a()) : s.call(r[0], n, i) : (r.is(":hidden") ? "hide" === c : "show" === c) ? (r[c](), a()) : s.call(r[0], n, a)
                }
    ...
    t.effects.define("bounce", function(e, i) {
        ...
        for (t.effects.createPlaceholder(a), o = a.css(g), u || (u = a["top" === g ? "outerHeight" : "outerWidth"]() / 3), c && (s = {
            opacity: 1
        }, s[g] = o, a.css("opacity", 0).css(g, b ? 2 * -u : 2 * u).animate(s, f, m)), l && (u /= Math.pow(2, d - 1)), s = {}, s[g] = o; d > v; v++)
            n = {},
            n[g] = (b ? "-=" : "+=") + u,
    ...
    t.effects.define("explode", "hide", function(e, i) {
        ...
        var o,
            ...
            _ = [];
        for (o = 0; u > o; o++)
            for (l = g.top + o * v, h = o - (u - 1) / 2, a = 0; d > a; a++)
                r = g.left + a * b,
                c = a - (d - 1) / 2,
    ...
    t.effects.define("size", function(e, i) {
        ...
        ("box" === d || "both" === d) && (s.from.y !== s.to.y && (b = t.effects.setTransition(a, l, s.from.y, b), v = t.effects.setTransition(a, l, s.to.y, v)), s.from.x !== s.to.x && (b = t.effects.setTransition(a, c, s.from.x, b), v = t.effects.setTransition(a, c, s.to.x, v))),
        ("content" === d || "both" === d) && s.from.y !== s.to.y && (b = t.effects.setTransition(a, r, s.from.y, b), v = t.effects.setTransition(a, r, s.to.y, v)),
        p && (n = t.effects.getBaseline(p, g), b.top = (g.outerHeight - b.outerHeight) * n.y + m.top, b.left = (g.outerWidth - b.outerWidth) * n.x + m.left, v.top = (g.outerHeight - v.outerHeight) * n.y + m.top, v.left = (g.outerWidth - v.outerWidth) * n.x + m.left),
        a.css(b),
        ("content" === d || "both" === d) && (l = l.concat(["marginTop", "marginBottom"]).concat(r), c = c.concat(["marginLeft", "marginRight"]), a.find("*[width]").each(function() {
            var i = t(this),
            ...
            s.from.x !== s.to.x && (o = t.effects.setTransition(i, c, s.from.x, o), a = t.effects.setTransition(i, c, s.to.x, a)),
        ...
        a.animate(v, {
            ...
            complete: function() {
                var e = a.offset();
                0 === v.opacity && a.css("opacity", b.opacity),
    ...
    t.effects.define("pulsate", "show", function(e, i) {
        var n = t(this),
            ...
            u = 1,
            d = n.queue().length;
        for ((o || !n.is(":visible")) && (n.css("opacity", 0).show(), h = 1); l > u; u++)
            n.animate({
                opacity: h
            }, c, e.easing),
            h = 1 - h;
    ...
    t.effects.define("shake", function(e, i) {
        var n = 1,
            ...
            f = {},
            m = s.queue().length;
        for (t.effects.createPlaceholder(s), d[h] = (u ? "-=" : "+=") + a, p[h] = (u ? "+=" : "-=") + 2 * a, f[h] = (u ? "-=" : "+=") + 2 * a, s.animate(d, c, e.easing); r > n; n++)
    ...
    t.effects.define("slide", "show", function(e, i) {
        ...
        "show" === r && (o.cssClip(d.clip), o.css(c, d[c]), d.clip = n, d[c] = s),
        o.animate(d, {
            queue: !1,
            duration: e.duration,
            easing: e.easing,
    ...
    t.extend(n.prototype, {
        ...
        _showDatepicker: function(e) {
            if (e = e.target || e, "input" !== e.nodeName.toLowerCase() && (e = t("input", e.parentNode)[0]), !t.datepicker._isDisabledDatepicker(e) && t.datepicker._lastInput !== e) {
                ...
                !1 !== (o = s ? s.apply(e, [e, n]) : {}) && (a(n.settings, o), n.lastVal = null, t.datepicker._lastInput = e, t.datepicker._setDateFromField(n), t.datepicker._inDialog && (e.value = ""), t.datepicker._pos || (t.datepicker._pos = t.datepicker._findPos(e), t.datepicker._pos[1] += e.offsetHeight), r = !1, t(e).parents().each(function() {
        ...
        parseDate: function(e, i, n) {
            ...
            if (-1 === m ? m = (new Date).getFullYear() : 100 > m && (m += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (h >= m ? 0 : -100)), v > -1)
                for (g = 1, b = v; !((o = this._getDaysInMonth(m, g - 1)) >= b);)
                    g++,
                    b -= o;
            if (r = this._daylightSavingAdjust(new Date(m, g - 1, b)), r.getFullYear() !== m || r.getMonth() + 1 !== g || r.getDate() !== b)
                throw "Invalid date";
            return r
        },
        ATOM: "yy-mm-dd",
        ...
        _generateHTML: function(t) {
            var e,
                ...
                tt = t.drawYear;
            if (0 > J && (J += 12, tt--), Z)
                for (e = this._daylightSavingAdjust(new Date(Z.getFullYear(), Z.getMonth() - Y[0] * Y[1] + 1, Z.getDate())), e = Q && Q > e ? Q : e; this._daylightSavingAdjust(new Date(tt, J, 1)) > e;)
                    0 > --J && (J = 11, tt--);
            for (t.drawMonth = J, t.drawYear = tt, i = this._get(t, "prevText"), i = U ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, J - V, 1)), this._getFormatConfig(t)) : i, n = this._canAdjustMonth(t, -1, tt, J) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (R ? "e" : "w") + "'>" + i + "</span></a>" : B ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (R ? "e" : "w") + "'>" + i + "</span></a>", s = this._get(t, "nextText"), s = U ? this.formatDate(s, this._daylightSavingAdjust(new Date(tt, J + V, 1)), this._getFormatConfig(t)) : s, o = this._canAdjustMonth(t, 1, tt, J) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (R ? "w" : "e") + "'>" + s + "</span></a>" : B ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (R ? "w" : "e") + "'>" + s + "</span></a>", a = this._get(t, "currentText"), r = this._get(t, "gotoCurrent") && t.currentDay ? G : W, a = U ? this.formatDate(a, r, this._getFormatConfig(t)) : a, l = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", c = q ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (R ? l : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (R ? "" : l) + "</div>" : "", h = parseInt(this._get(t, "firstDay"), 10), h = isNaN(h) ? 0 : h, u = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), m = this._get(t, "monthNamesShort"), g = this._get(t, "beforeShowDay"), b = this._get(t, "showOtherMonths"), v = this._get(t, "selectOtherMonths"), _ = this._getDefaultDate(t), y = "", x = 0; Y[0] > x; x++) {
                for (k = "", this.maxRows = 4, C = 0; Y[1] > C; C++) {
                    if (D = this._daylightSavingAdjust(new Date(tt, J, t.selectedDay)), T = " ui-corner-all", M = "", X) {
                        if (M += "<div class='ui-datepicker-group", Y[1] > 1)
                            switch (C) {
                            case 0:
                    ...
                    for (M += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === x ? R ? o : n : "") + (/all|right/.test(T) && 0 === x ? R ? n : o : "") + this._generateMonthYearHeader(t, J, tt, Q, Z, x > 0 || C > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", I = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; 7 > w; w++)
                        P = (w + h) % 7,
                        I += "<th scope='col'" + ((w + h + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[P] + "'>" + p[P] + "</span></th>";
                    for (M += I + "</tr></thead><tbody>", S = this._getDaysInMonth(tt, J), tt === t.selectedYear && J === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, S)), j = (this._getFirstDayOfMonth(tt, J) - h + 7) % 7, A = Math.ceil((j + S) / 7), E = X && this.maxRows > A ? this.maxRows : A, this.maxRows = E, O = this._daylightSavingAdjust(new Date(tt, J, 1 - j)), N = 0; E > N; N++) {
                        for (M += "<tr>", H = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(O) + "</td>" : "", w = 0; 7 > w; w++)
                            L = g ? g.apply(t.input ? t.input[0] : null, [O]) : [!0, ""],
                            $ = O.getMonth() !== J,
                            z = $ && !v || !L[0] || Q && Q > O || Z && O > Z,
                            H += "<td class='" + ((w + h + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + ($ ? " ui-datepicker-other-month" : "") + (O.getTime() === D.getTime() && J === t.selectedMonth && t._keyEvent || _.getTime() === O.getTime() && _.getTime() === D.getTime() ? " " + this._dayOverClass : "") + (z ? " " + this._unselectableClass + " ui-state-disabled" : "") + ($ && !b ? "" : " " + L[1] + (O.getTime() === G.getTime() ? " " + this._currentClass : "") + (O.getTime() === W.getTime() ? " ui-datepicker-today" : "")) + "'" + ($ && !b || !L[2] ? "" : " title='" + L[2].replace(/'/g, "&#39;") + "'") + (z ? "" : " data-handler='selectDay' data-event='click' data-month='" + O.getMonth() + "' data-year='" + O.getFullYear() + "'") + ">" + ($ && !b ? "&#xa0;" : z ? "<span class='ui-state-default'>" + O.getDate() + "</span>" : "<a class='ui-state-default" + (O.getTime() === W.getTime() ? " ui-state-highlight" : "") + (O.getTime() === G.getTime() ? " ui-state-active" : "") + ($ ? " ui-priority-secondary" : "") + "' href='#'>" + O.getDate() + "</a>") + "</td>",
                    ...
                    J++,
                    J > 11 && (J = 0, tt++),
                    M += "</tbody></table>" + (X ? "</div>" + (Y[0] > 0 && C === Y[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""),
                    k += M
                }
                y += k
            }
        ...
        _generateMonthYearHeader: function(t, e, i, n, s, o, a, r) {
            ...
            if (o || !g)
                ...
                for (l = n && n.getFullYear() === i, c = s && s.getFullYear() === i, y += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", h = 0; 12 > h; h++)
                    (!l || h >= n.getMonth()) && (!c || s.getMonth() >= h) && (y += "<option value='" + h + "'" + (h === e ? " selected='selected'" : "") + ">" + r[h] + "</option>");
                y += "</select>"
            }
    ...
    t.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(e, i, n) {
            ...
            for (d = n.snapElements.length - 1; d >= 0; d--)
                ...
                l - m > b || g > c + m || h - m > _ || v > u + m || !t.contains(n.snapElements[d].item.ownerDocument, n.snapElements[d].item) ? (n.snapElements[d].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
    ...
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _updateVirtualBoundaries: function(t) {
            ...
            (this._aspectRatio || t) && (e = o.minHeight * this.aspectRatio, n = o.minWidth / this.aspectRatio, i = o.maxHeight * this.aspectRatio, s = o.maxWidth / this.aspectRatio, e > o.minWidth && (o.minWidth = e), n > o.minHeight && (o.minHeight = n), o.maxWidth > i && (o.maxWidth = i), o.maxHeight > s && (o.maxHeight = s)),
            this._vBoundaries = o
        },
    ...
    t.ui.plugin.add("resizable", "containment", {
        ...
        resize: function(e) {
            ...
            c.left < (a._helper ? l.left : 0) && (a.size.width = a.size.width + (a._helper ? a.position.left - l.left : a.position.left - u.left), h && (a.size.height = a.size.width / a.aspectRatio, p = !1), a.position.left = r.helper ? l.left : 0),
            c.top < (a._helper ? l.top : 0) && (a.size.height = a.size.height + (a._helper ? a.position.top - l.top : a.position.top), h && (a.size.width = a.size.height * a.aspectRatio, p = !1), a.position.top = a._helper ? l.top : 0),
    ...
    t.widget("ui.selectmenu", [t.ui.formResetMixin, {
        ...
        _renderMenu: function(e, i) {
            ...
            t.each(i, function(i, o) {
                ...
                o.optgroup !== s && (a = t("<li>", {
                    text: o.optgroup
                }), n._addClass(a, "ui-selectmenu-optgroup", "ui-menu-divider" + (o.element.parent("optgroup").prop("disabled") ? " ui-state-disabled" : "")), a.appendTo(e), s = o.optgroup),
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _refreshItems: function(e) {
            ...
            for (i = u.length - 1; i >= 0; i--)
                for (a = u[i][1], r = u[i][0], n = 0, c = r.length; c > n; n++)
                    l = t(r[n]),
        ...
        _contactContainers: function(e) {
            ...
            if (d)
                if (1 === this.containers.length)
                    ...
                    for (s = 1e4, o = null, h = d.floating || this._isFloating(this.currentItem), a = h ? "left" : "top", r = h ? "width" : "height", u = h ? "pageX" : "pageY", n = this.items.length - 1; n >= 0; n--)
                        t.contains(this.containers[p].element[0], this.items[n].item[0]) && this.items[n].item[0] !== this.currentItem[0] && (l = this.items[n].item.offset()[a], c = !1, e[u] - l > this.items[n][r] / 2 && (c = !0), s > Math.abs(e[u] - l) && (s = Math.abs(e[u] - l), o = this.items[n], this.direction = c ? "up" : "down"));
...
function(t, e, i) {
    ...
    function r(t, e) {
        var i,
            ...
            s,
            o = [];
        for (i = t, "+" === i ? i = ["+"] : (i = i.replace(/\+{2}/g, "+plus"), i = i.split("+")), s = 0; s < i.length; ++s)
            n = i[s],
            f[n] && (n = f[n]),
            e && "keypress" != e && p[n] && (n = p[n], o.push("shift")),
            a(n) && o.push(n);
        if (i = n, !(s = e)) {
            if (!h) {
                h = {};
                for (var r in u)
                    95 < r && 112 > r || u.hasOwnProperty(r) && (h[u[r]] = r)
            }
    ...
    function c(t) {
        ...
        function l(t, e, i, n, s, o) {
            ...
            for ("keyup" == h && a(t) && (e = [t]), r = 0; r < f._callbacks[t].length; ++r)
                if (l = f._callbacks[t][r], (n || !l.seq || g[l.seq] == l.level) && h == l.action) {
                    var u;
                    (u = "keypress" == h && !i.metaKey && !i.ctrlKey) || (u = l.modifiers, u = e.sort().join(",") === u.sort().join(",")),
                    u && (u = n && l.seq == n && l.level == o, (!n && l.combo == s || u) && f._callbacks[t].splice(r, 1), c.push(l))
                }
            return c
        }
        function h(t, e, i, n) {
        ...
        f._handleKey = function(t, e, n) {
            ...
            for (s = 0; s < o.length; ++s)
                o[s].seq && (r = Math.max(r, o[s].level));
            for (s = 0; s < o.length; ++s)
                o[s].seq ? o[s].level == r && (c = !0, e[o[s].seq] = 1, h(o[s].callback, n, o[s].combo, o[s].seq)) : c || h(o[s].callback, n, o[s].combo);
            o = "keypress" == n.type && v,
            n.type != _ || a(t) || o || i(e),
            v = c && "keydown" == n.type
        },
...
function(t, e) {
    ...
    var t = null,
        ...
        h = function(e, i, s, o) {
            ...
            null == t && (t = document.body.style.overflow, document.body.style.overflow = "hidden");
            var h = n(),
                u = l(i, h);
        ...
        1: [function(t, e, i) {
            ...
            var n = null,
                ...
                h = (i.show = function t(e) {
                    ...
                    "function" == typeof e.select ? e.select() : e.focus(),
                    s().classList.remove("basicModal--fadeIn", "basicModal--shake"),
                    setTimeout(function() {
...
var _templateObject = _taggedTemplateLiteral(["<p>Sind Sie sicher, dass du das Album '$", "' und alle darin enthaltenen Fotos löschen möchtest? Diese Aktion kann nicht rückgängig gemacht werden!</p>"], ["<p>Sind Sie sicher, dass du das Album '$", "' und alle darin enthaltenen Fotos löschen möchtest? Diese Aktion kann nicht rückgängig gemacht werden!</p>"]),
    _templateObject2 = _taggedTemplateLiteral(["<p>Bist du sicher, dass du alle $", " ausgewählten Alben und alle darin enthaltenen Fotos löschen möchtest? Diese Aktion kann nicht rückgängig gemacht werden!</p>"], ["<p>Bist du sicher, dass du alle $", " ausgewählten Alben und alle darin enthaltenen Fotos löschen möchtest? Diese Aktion kann nicht rückgängig gemacht werden!</p>"]),
    _templateObject3 = _taggedTemplateLiteral(["<input class='text' name='title' type='text' maxlength='50' placeholder='Titel' value='$", "'>"], ["<input class='text' name='title' type='text' maxlength='50' placeholder='Titel' value='$", "'>"]),
    _templateObject4 = _taggedTemplateLiteral(["<p>Geben einen neuen Titel für dieses Album ein: ", "</p>"], ["<p>Geben einen neuen Titel für dieses Album ein: ", "</p>"]),
...
!function(t) {
    ...
    e.prototype = {
        ...
        mouseDown: function(t) {
            var e = this;
            this.swipeStart(t, t.pageX, t.pageY),
        ...
        swipeStart: function(t, e, i) {
            ...
            this.trigger("swipeStart", t)
        },
        swipeMove: function(t, e, i) {
            this.pos.end.x = e,
            this.pos.end.y = i,
            this.trigger("swipeMove", t)
        },
        swipeEnd: function(t) {
        ...
        trigger: function(e, i) {
            ...
            h <= 45 && h >= 0 || h <= 360 && h >= 315 ? l = "left" : h >= 135 && h <= 225 ? l = "right" : h > 45 && h < 135 && (l = "down"),
            s.originalEvent = i,
            s.swipe = {
                x: o,
                y: a,
...
album.load = function(t) {
    ...
    $(".content").sortable({
        stop: function(t, e) {
            ...
            api.post("Album::setPosition", s, function(t) {
                console.log("Album::setPosition returned: " + t),
    ...
    password.get(t, function() {
        ...
        api.post("Album::get", n, function(n) {
            var s = 0;
            if ("Warning: Album private!" === n)
                return void 0 != document.location.hash.replace("#", "").split("/")[1] ? lychee.setMode("view") : (lychee.content.show(), lychee.goto()), !1;
            if ("Warning: Wrong password!" === n)
                return album.load(t, e), !1;
            album.json = n;
            var o = (new Date).getTime() - i;
            s = o > 300 ? 0 : 300 - o,
            !0 === e && (s = 0),
            visible.albums() || visible.photo() || visible.album() || (s = 0),
            setTimeout(function() {
                view.album.init(),
                !1 === e && (lychee.animate(lychee.content, "contentZoomIn"), header.setMode("album"))
            }, s)
        })
    })
},
...
album.add = function() {
    ...
    basicModal.show({
        body: "<p>Geben einen Titel für das neue Album ein: <input class='text' name='title' type='text' maxlength='50' placeholder='Title' value='Untitled'></p>",
        buttons: {
            action: {
    ...
    if (t instanceof Array == !1 && (t = [t]), e.fn = function() {
        ...
        api.post("Album::delete", e, function(i) {
            visible.albums() ? t.forEach(function(t) {
                albums.json.num--,
                view.albums.content.delete(t),
                albums.deleteByID(t)
            }) : (albums.refresh(), lychee.goto()),
            !0 !== i && lychee.error(null, e, i)
        })
    }, "0" === t.toString())
        e.title = "Lösche Unsortierte",
        i.title = "Behalte Unsortierte",
        n = "<p>Bist du sicher, dass du alle Fotos aus 'Unsortiert' löschen willst?<br>Diese Aktion kann nicht rückgängig gemacht werden!</p>";
    else if (1 === t.length) {
        var s = "";
        e.title = "Lösche Album und Fotos",
        i.title = "Behalte Album",
        album.json ? s = album.json.title : albums.json && (s = albums.getByID(t).title),
        "" === s && (s = "Untitled"),
        n = lychee.html(_templateObject, s)
    } else
        e.title = "Lösche Alben und Fotos",
        i.title = "Behalte Alben",
        n = lychee.html(_templateObject2, t.length);
    basicModal.show({
        body: n,
        buttons: {
            action: {
...
album.setTitle = function(t) {
    ...
    1 === t.length && (album.json ? e = album.json.title : albums.json && (e = albums.getByID(t).title));
    var n = function(e) {
            basicModal.close();
            var i = e.title;
            visible.album() ? (album.json.title = i, view.album.title(), albums.json && (albums.getByID(t[0]).title = i)) : visible.albums() && t.forEach(function(t) {
                albums.getByID(t).title = i,
                view.albums.content.title(t)
            });
            var n = {
                albumIDs: t.join(),
                title: i
    ...
    i = 1 === t.length ? lychee.html(_templateObject4, s) : lychee.html(_templateObject5, t.length, s),
    basicModal.show({
        body: i,
        buttons: {
            action: {
...
album.setDescription = function(t) {
    var e = album.json.description,
        i = function(e) {
            var i = e.description;
            basicModal.close(),
            visible.album() && (album.json.description = i, view.album.description());
            var n = {
                albumID: t,
                description: i
            };
...
album.setPublic = function(t, e, i) {
    ...
    if (albums.refresh(), !0 === e) {
        ...
        "1" === album.json.public ? (o.title = "Teilung bearbeiten", s = "Die Freigabeeigenschaften dieses Albums werden wie folgt geändert:") : (o.title = "Album teilen", s = "Dieses Album wird mit den folgenden Eigenschaften geteilt:");
        var a = "\n\t\t          <p class='less'>" + s + "</p>\n\t\t          <form>\n\t\t              <div class='choice'>\n\t\t                  <label>\n\t\t                      <input type='checkbox' name='hidden'>\n\t\t                      <span class='checkbox'>" + build.iconic("check") + "</span>\n\t\t                      <span class='label'>Versteckt</span>\n\t\t                  </label>\n\t\t                  <p>Nur Personen mit dem direkten Link können dieses Album sehen.</p>\n\t\t              </div>\n\t\t              <div class='choice'>\n\t\t                  <label>\n\t\t                      <input type='checkbox' name='downloadable'>\n\t\t                      <span class='checkbox'>" + build.iconic("check") + "</span>\n\t\t                      <span class='label'>Downloadbar</span>\n\t\t                  </label>\n\t\t                  <p>Besucher deiner Website können dieses Album herunterladen.</p>\n\t\t              </div>\n\t\t              <div class='choice'>\n\t\t                  <label>\n\t\t                      <input type='checkbox' name='password'>\n\t\t                      <span class='checkbox'>" + build.iconic("check") + "</span>\n\t\t                      <span class='label'>Passwort geschützt</span>\n\t\t                  </label>\n\t\t                  <p>Das Album ist nur mit einem gültigen Passwort zugänglich.</p>\n\t\t                  <input class='text' name='passwordtext' type='password' placeholder='Passwort' value=''>\n\t\t              </div>\n\t\t          </form>\n\t\t          ";
    ...
    visible.album() && (album.json.visible = "0" === album.json.public ? "1" : album.json.visible, album.json.downloadable = "0" === album.json.public ? "0" : album.json.downloadable, album.json.password = "0" === album.json.public ? "0" : album.json.password, view.album.public(), view.album.hidden(), view.album.downloadable(), view.album.password(), "1" === album.json.public && contextMenu.shareAlbum(t, i));
    var r = {
        albumID: t,
...
album.getArchive = function(t) {
    ...
    e = location.href.indexOf("index.html") > 0 ? location.href.replace(location.hash, "").replace("index.html", i) : location.href.replace(location.hash, "") + i,
    !0 === lychee.publicMode && (e += "&password=" + encodeURIComponent(password.value)),
    location.href = e
},
album.merge = function(t) {
    ...
    if (!t)
        return !1;
    t instanceof Array == !1 && (t = [t]),
    albums.json && (e = albums.getByID(t[0]).title),
    "" === e && (e = "Untitled"),
    2 === t.length ? (albums.json && (i = albums.getByID(t[1]).title), "" === i && (i = "Untitled"), n = lychee.html(_templateObject7, i, e)) : n = lychee.html(_templateObject8, e);
    var s = function() {
        basicModal.close();
        var e = {
            albumIDs: t.join()
    ...
    basicModal.show({
        ...
        buttons: {
            action: {
                title: "Alben zusammenführen",
                fn: s,
                class: "red"
            },
            cancel: {
                title: "Nicht zusammenführen",
                fn: basicModal.close
            }
        }
    })
...
albums.load = function() {
    ...
    null === albums.json ? api.post("Albums::get", {}, function(e) {
        var i = 0;
        !1 === lychee.publicMode && albums._createSmartAlbums(e.smartalbums),
        albums.json = e;
        var n = (new Date).getTime() - t;
        i = n > 300 ? 0 : 300 - n,
        visible.albums() || visible.photo() || visible.album() || (i = 0),
        visible.album() && "" === lychee.content.html() && (i = 0),
        setTimeout(function() {
...
albums.deleteByID = function(t) {
    ...
    var e = !1;
    return $.each(albums.json.albums, function(i) {
        if (albums.json.albums[i].id == t)
            return albums.json.albums.splice(i, 1), e = !0, !1
    }), e
},
...
api.post = function(t, e, i) {
    ...
    var n = function(t) {
            if (setTimeout(loadingBar.hide, 100), "string" == typeof t && "Error: " === t.substring(0, 7))
                return api.onError(t.substring(7, t.length), e, t), !1;
            i(t)
        },
        s = function(t, i, n) {
...
build.no_content = function(t) {
    ...
    case "magnifying-glass":
        ...
        break;
    case "eye":
        e += "<p>Keine öffentlichen Alben</p>";
        break;
    case "cog":
        e += "<p>Keine Konfigurierung</p>";
        break;
    case "question-mark":
        e += "<p>Foto nicht gefunden</p>"
    }
    return e += "</div>"
},
build.uploadModal = function(t, e) {
    ...
    for (var n = 0; n < e.length;) {
        var s = e[n];
        s.name.length > 40 && (s.name = s.name.substr(0, 17) + "..." + s.name.substr(s.name.length - 20, 20)),
        i += lychee.html(_templateObject22, s.name),
        n++
    }
    return i += "</div>"
},
...
contextMenu = {},
contextMenu.add = function(t) {
    var e = [{
        title: build.iconic("image") + "Foto hochladen",
        fn: function() {
            return $("#upload_files").click()
        }
    }, {}, {
        title: build.iconic("link-intact") + "Importieren von Link",
        fn: upload.start.url
    }, {
        title: build.iconic("dropbox", "ionicons") + "Importieren von Dropbox",
        fn: upload.start.dropbox
    }, {
        title: build.iconic("terminal") + "Importieren vom Server",
        fn: upload.start.server
    }, {}, {
        title: build.iconic("folder") + "Neues Album",
        fn: album.add
    }];
...
contextMenu.settings = function(t) {
    var e = [{
        title: build.iconic("person") + "Login ändern",
        fn: settings.setLogin
    }, {
        title: build.iconic("sort-ascending") + "Sortierung ändern",
        fn: settings.setSorting
    }, {
        title: build.iconic("dropbox", "ionicons") + "Dropbox einrichten",
        fn: settings.setDropboxKey
    }, {}, /*{
        title: build.iconic("info") + "Über Lychee",
        fn: function() {
            return window.open(lychee.website)
        }
    },*/ {
        title: build.iconic("wrench") + "Analyse",
        fn: function() {
            return window.open("plugins/Diagnostics/")
        }
    }, {
        title: build.iconic("align-left") + "Log anzeigen",
        fn: function() {
            return window.open("plugins/Log/")
        }
    }, {}, {
        title: build.iconic("account-logout") + "Abmelden",
        fn: lychee.logout
    }];
    basicContext.show(e, t.originalEvent)
},
contextMenu.album = function(t, e) {
    ...
    var i = albums.json && albums.json.albums && Object.keys(albums.json.albums).length > 1,
        n = [{
            title: build.iconic("pencil") + "Umbenennen",
            fn: function() {
                return album.setTitle([t])
            }
        }, {
            title: build.iconic("collapse-left") + "Zusammenführen",
            visible: i,
            fn: function() {
                basicContext.close(),
                contextMenu.mergeAlbum(t, e)
            }
        }, {
            title: build.iconic("trash") + "Löschen",
            fn: function() {
                return album.delete([t])
            }
        }];
    $('.album[data-id="' + t + '"]').addClass("active"),
...
contextMenu.albumMulti = function(t, e) {
    ...
    var i = t.length > 1,
        ...
        s = [{
            title: build.iconic("pencil") + "Alle umbenennen",
            fn: function() {
                return album.setTitle(t)
            }
        }, {
            title: build.iconic("collapse-left") + "Alle zusammenführen",
            visible: n && i,
            fn: function() {
            ...
            fn: function() {
                basicContext.close(),
                contextMenu.mergeAlbum(t[0], e)
            }
        }, {
            title: build.iconic("trash") + "Alle löschen",
            fn: function() {
                return album.delete(t)
            }
        }];
    s.push(),
    basicContext.show(s, e.originalEvent, contextMenu.close)
},
contextMenu.albumTitle = function(t, e) {
    api.post("Albums::get", {}, function(i) {
        ...
        i.albums && i.num > 1 && ($.each(i.albums, function() {
            var e = this;
            this.thumbs[0] || (this.thumbs[0] = "src/images/no_cover.svg"),
...
contextMenu.mergeAlbum = function(t, e) {
    api.post("Albums::get", {}, function(i) {
        ...
        if (i.albums && i.num > 1 && $.each(i.albums, function() {
            var e = this;
            this.thumbs[0] || (this.thumbs[0] = "src/images/no_cover.svg"),
            "" === this.title && (this.title = "Unbenannt");
            var i = lychee.html(_templateObject24, this.thumbs[0], this.title);
            this.id != t && n.push({
                title: i,
                fn: function() {
...
contextMenu.photo = function(t, e) {
    var i = [{
        title: build.iconic("star") + "Favorisieren",
        fn: function() {
            return photo.setStar([t])
        }
    }, {
        title: build.iconic("tag") + "Tag setzten",
        fn: function() {
        ...
        title: build.iconic("layers") + "Duplizieren",
        fn: function() {
            return photo.duplicate([t])
        }
    }, {
        title: build.iconic("folder") + "Bewegen",
        fn: function() {
            basicContext.close(),
            contextMenu.move([t], e)
        }
    }, {
        title: build.iconic("trash") + "Löschen",
        fn: function() {
    ...
    $('.photo[data-id="' + t + '"]').addClass("active"),
    basicContext.show(i, e.originalEvent, contextMenu.close)
},
contextMenu.photoMulti = function(t, e) {
    multiselect.stopResize();
    var i = [{
        title: build.iconic("star") + "Alle favorisieren",
        fn: function() {
            return photo.setStar(t)
        }
    }, {
        title: build.iconic("tag") + "Alle Tags setzten",
        fn: function() {
            return photo.editTags(t)
        }
    }, {}, {
        ...
        title: build.iconic("layers") + "Alle duplizieren",
        fn: function() {
            return photo.duplicate(t)
        }
    }, {
        title: build.iconic("folder") + "Alle bewegen",
        fn: function() {
            basicContext.close(),
            contextMenu.move(t, e)
        }
...
contextMenu.photoMore = function(t, e) {
    var i = !1 === lychee.publicMode || album.json && album.json.downloadable && "1" === album.json.downloadable && !0 === lychee.publicMode,
        n = [{
            title: build.iconic("fullscreen-enter") + "Vollständiges Foto",
            fn: function() {
...
contextMenu.sharePhoto = function(t, e) {
    ...
    !0 === lychee.publicMode && n.splice(7, 1),
    basicContext.show(n, e.originalEvent),
...
contextMenu.shareAlbum = function(t, e) {
    ...
    !0 === lychee.publicMode && i.splice(5, 1),
    basicContext.show(i, e.originalEvent),
    $(".basicContext input#link").focus().select()
},
contextMenu.close = function() {
    ...
    visible.multiselect() && multiselect.close()
},
header = {
    _dom: $(".header")
},
...
$(document).ready(function() {
    ...
    multiselect.bind(),
    header.bind(),
    lychee.imageview.on(t, ".arrow_wrapper--previous", photo.previous).on(t, ".arrow_wrapper--next", photo.next),
    Mousetrap.bind(["left"], function() {
        if (visible.photo())
            return $("#imageview a#previous").click(), !1
    }).bind(["right"], function() {
        if (visible.photo())
            return $("#imageview a#next").click(), !1
    }).bind(["u"], function() {
        if (!visible.photo())
            return $("#upload_files").click(), !1
    }).bind(["s", "f"], function() {
        ...
        if (visible.photo())
            return photo.editTags([photo.getID()]), !1
    }).bind(["i"], function() {
        if (!visible.multiselect())
            return sidebar.toggle(), !1
...
loadingBar.show = function(t, e) {
    return "error" === t ? (loadingBar.status = "error", e && (e = e.replace("<br>", "")), e || (e = "Whoops, it looks like something went wrong. Please reload the site and try again!"), visible.header() && header.dom().addClass("header--error"), loadingBar.dom().removeClass("loading uploading error").html("<h1>Error: <span>" + e + "</span></h1>").addClass(t).show(), clearTimeout(loadingBar._timeout), loadingBar._timeout = setTimeout(function() {
        ...
        visible.header() && header.dom().addClass("header--loading"),
...
lychee.init = function() {
    api.post("Session::init", {}, function(t) {
        if (2 === t.status)
            lychee.sortingPhotos = t.config.sortingPhotos || "",
            lychee.sortingAlbums = t.config.sortingAlbums || "",
            lychee.dropboxKey = t.config.dropboxKey || "",
            lychee.location = t.config.location || "",
            lychee.checkForUpdates = t.config.checkForUpdates || "1",
            !1 === t.config.login && settings.createLogin();
        else if (1 === t.status)
            lychee.checkForUpdates = t.config.checkForUpdates || "1",
            lychee.setMode("public");
        else if (0 === t.status)
            return lychee.setMode("public"), header.dom().hide(), lychee.content.hide(), $("body").append(build.no_content("cog")), settings.createConfig(), !0;
...
lychee.setTitle = function(t, e) {
    document.title = lychee.title + " | " + t,
    header.setEditable(e),
    header.setTitle(t)
},
lychee.setMode = function(t) {
    ...
    "public" === t ? lychee.publicMode = !0 : "view" === t && (Mousetrap.unbind(["esc", "command+up"]), $("#button_back, a#next, a#previous").remove(), $(".no_content").remove(), lychee.publicMode = !0, lychee.viewMode = !0)
},
lychee.animate = function(t, e) {
    ...
    for (var n = 0; n < i.length; n++)
        for (var s = 0; s < i[n].length; s++)
            if (i[n][s] == e)
                return t.removeClass(i[n][0] + " " + i[n][1]).addClass(e), !0;
    return !1
},
...
lychee.loadDropbox = function(t) {
    if (!1 === lychee.dropbox && null != lychee.dropboxKey && "" !== lychee.dropboxKey) {
        ...
        e.src = "https://www.dropbox.com/static/api/1/dropins.js",
        e.id = "dropboxjs",
        e.type = "text/javascript",
        e.async = "true",
        e.setAttribute("data-app-key", lychee.dropboxKey),
        ...
        !0 === lychee.dropbox && null != lychee.dropboxKey && "" !== lychee.dropboxKey ? t() : settings.setDropboxKey(t)
},
...
lychee.html = function(t) {
    for (var e = t.raw, i = "", n = arguments.length, s = Array(n > 1 ? n - 1 : 0), o = 1; o < n; o++)
        s[o - 1] = arguments[o];
    return s.forEach(function(t, n) {
        var s = e[n];
        "$" === s.slice(-1) && (t = lychee.escapeHTML(t), s = s.slice(0, -1)),
        i += s,
        i += t
    }), i += e[e.length - 1]
},
...
multiselect.selectAll = function() {
    ...
    if (!visible.albums() && !visible.album)
        return !1;
    visible.multiselect() && $("#multiselect").remove(),
    sidebar.setSelectable(!1),
    ...
    $("#multiselect").css(e),
    multiselect.getSelection(i)
},
multiselect.resize = function(t) {
    if (null === multiselect.position.top || null === multiselect.position.right || null === multiselect.position.bottom || null === multiselect.position.left)
        return !1;
    var e = {},
        i = {},
        n = {
    ...
    n.y >= multiselect.position.top ? (i.height = $(document).height(), e.height = n.y - multiselect.position.top, multiselect.position.top + e.height >= i.height && (e.height -= multiselect.position.top + e.height - i.height + 2), s.top = multiselect.position.top, s.bottom = "inherit", s.height = e.height) : (s.top = "inherit", s.bottom = multiselect.position.bottom, s.height = multiselect.position.top - t.pageY),
    n.x >= multiselect.position.left ? (i.width = $(document).width(), e.width = n.x - multiselect.position.left, multiselect.position.left + e.width >= i.width && (e.width -= multiselect.position.left + e.width - i.width + 2), s.right = "inherit", s.left = multiselect.position.left, s.width = e.width) : (s.right = multiselect.position.right, s.left = "inherit", s.width = multiselect.position.left - t.pageX),
    $("#multiselect").css(s)
},
...
password.getDialog = function(t, e) {
    var i = function(i) {
        ...
        n = function() {
            basicModal.close(),
            visible.albums() || lychee.goto()
        };
    basicModal.show({
        body: "\n\t          <p>\n\t              Dieses Album ist durch ein Passwort geschützt. Geben das Passwort unten ein, um die Fotos dieses Albums zu sehen:\n\t              <input name='password' class='text' type='password' placeholder='password' value=''>\n\t          </p>\n\t          ",
        buttons: {
            action: {
                title: "Eingabe",
                fn: i
...
photo.preloadNext = function(t) {
    if (album.json && album.json.content && album.json.content[t] && "" != album.json.content[t].nextPhoto) {
        ...
        $("head").append('<link data-prefetch rel="prefetch" href="' + s + '">')
    }
},
...
photo.delete = function(t) {
    ...
    if (!t)
        return !1;
    t instanceof Array == !1 && (t = [t]),
    1 === t.length && "" === (s = visible.photo() ? photo.json.title : album.json.content[t].title) && (s = "Untitled"),
    e.fn = function() {
        var e = null,
            i = null;
        basicModal.close(),
        t.forEach(function(t, n, s) {
            "" === album.json.content[t].nextPhoto && "" === album.json.content[t].previousPhoto || (e = album.json.content[t].nextPhoto, i = album.json.content[t].previousPhoto, album.json.content[i].nextPhoto = e, album.json.content[e].previousPhoto = i),
            delete album.json.content[t],
            view.album.content.delete(t)
        }),
        albums.refresh(),
        visible.photo() && null != e && e !== photo.getID() ? lychee.goto(album.getID() + "/" + e) : visible.albums() || lychee.goto(album.getID());
        var n = {
            photoIDs: t.join()
        };
...
photo.setTitle = function(t) {
    ...
    if (!t)
        return !1;
    t instanceof Array == !1 && (t = [t]),
    1 === t.length && (photo.json ? e = photo.json.title : album.json && (e = album.json.content[t].title));
    var n = function(e) {
            basicModal.close();
            var i = e.title;
            visible.photo() && (photo.json.title = "" === i ? "Untitled" : i, view.photo.title()),
            t.forEach(function(t, e, n) {
                album.json.content[t].title = i,
                view.album.content.title(t)
            });
            var n = {
                photoIDs: t.join(),
                title: i
        ...
        s = lychee.html(_templateObject3, e);
    i = 1 === t.length ? lychee.html(_templateObject29, s) : lychee.html(_templateObject30, t.length, s),
    basicModal.show({
        body: i,
        buttons: {
            action: {
...
photo.setAlbum = function(t, e) {
    ...
    t.forEach(function(t, e, s) {
        "" === album.json.content[t].nextPhoto && "" === album.json.content[t].previousPhoto || (i = album.json.content[t].nextPhoto, n = album.json.content[t].previousPhoto, album.json.content[n].nextPhoto = i, album.json.content[i].previousPhoto = n),
        delete album.json.content[t],
        view.album.content.delete(t)
    }),
    albums.refresh(),
    visible.photo() && null != i && i !== photo.getID() ? lychee.goto(album.getID() + "/" + i) : visible.albums() || lychee.goto(album.getID());
    var s = {
        photoIDs: t.join(),
        albumID: e
    };
...
photo.setStar = function(t) {
    if (!t)
        return !1;
    visible.photo() && (photo.json.star = "0" === photo.json.star ? "1" : "0", view.photo.star()),
    t.forEach(function(t, e, i) {
        album.json.content[t].star = "0" === album.json.content[t].star ? "1" : "0",
        view.album.content.star(t)
    }),
    albums.refresh();
    var e = {
        photoIDs: t.join()
...
photo.setPublic = function(t, e) {
    if ("2" === photo.json.public) {
        ...
        return basicModal.show({
            body: "<p>Dieses Foto befindet sich in einem öffentlichen Album. Um dieses Foto privat oder öffentlich zu machen, bearbeiten die Sichtbarkeit des zugehörigen Albums.</p>",
            buttons: {
                action: {
                    title: "Album zeigen",
                    fn: i
    ...
    visible.photo() && (photo.json.public = "0" === photo.json.public ? "1" : "0", view.photo.public(), "1" === photo.json.public && contextMenu.sharePhoto(t, e)),
    album.json.content[t].public = "0" === album.json.content[t].public ? "1" : "0",
    view.album.content.public(t),
    albums.refresh(),
...
photo.editTags = function(t) {
    ...
    if (!t)
        return !1;
    if (t instanceof Array == !1 && (t = [t]), visible.photo())
        e = photo.json.tags;
    else if (visible.album() && 1 === t.length)
        e = album.json.content[t].tags;
    else if (visible.search() && 1 === t.length)
        e = album.json.content[t].tags;
    ...
    var s = function(e) {
            basicModal.close(),
            photo.setTags(t, e.tags)
        },
        o = lychee.html(_templateObject32, e);
    i = 1 === t.length ? lychee.html(_templateObject33, o) : lychee.html(_templateObject34, t.length, o),
    basicModal.show({
        body: i,
        buttons: {
            action: {
...
photo.setTags = function(t, e) {
    ...
    e = e.replace(/(\ ,\ )|(\ ,)|(,\ )|(,{1,}\ {0,})|(,$|^,)/g, ","),
    e = e.replace(/,$|^,|(\ ){0,}$/g, ""),
    visible.photo() && (photo.json.tags = e, view.photo.tags()),
...
photo.deleteTag = function(t, e) {
    var i = void 0;
    i = photo.json.tags.split(","),
    i.splice(e, 1),
    photo.json.tags = i.toString(),
    photo.setTags([t], photo.json.tags)
},
...
search.find = function(t) {
    ...
    $(window).data("timeout", setTimeout(function() {
        0 !== header.dom(".header__search").val().length ? api.post("search", {
            ...
            e = "" === i && "" === n ? "error" : "" === i ? build.divider("Photos") + n : "" === n ? build.divider("Albums") + i : build.divider("Albums") + i + build.divider("Photos") + n,
            search.hash !== t.hash && ($(".no_content").remove(), lychee.animate(".content", "contentZoomOut"), search.hash = t.hash, setTimeout(function() {
...
search.reset = function() {
    ...
    $(".no_content").remove(),
    null != search.hash && (albums.json = null, album.json = null, photo.json = null, search.hash = null, lychee.animate(".divider", "fadeOut"), lychee.goto())
},
settings = {},
settings.createConfig = function() {
    var t = function(t) {
        var e = t.dbName || "",
            ...
            o = t.dbTablePrefix || "";
        if (i.length < 1)
            return basicModal.error("dbUser"), !1;
        s.length < 1 && (s = "localhost"),
        e.length < 1 && (e = "lychee");
        var a = {
            dbName: e,
            dbUser: i,
        ...
        api.post("Config::create", a, function(t) {
            if (!0 !== t)
                return "Warning: Connection failed!" === t ? (basicModal.show({
...
settings.createLogin = function() {
    var t = function(t) {
        var e = t.username,
            i = t.password;
        if (e.length < 1)
            return basicModal.error("username"), !1;
        if (i.length < 1)
            return basicModal.error("password"), !1;
        basicModal.close();
        var n = {
            username: e,
            password: i
        ...
        api.post("Settings::setLogin", n, function(t) {
            !0 !== t && basicModal.show({
                body: "<p>Login kann nicht gespeichert werden. Bitte versuche es erneut mit einem anderen Benutzernamen und Passwort!</p>",
                buttons: {
                    action: {
                        title: "Erneut versuchen",
    ...
    basicModal.show({
        body: "\n\t          <p>\n\t              Gebe einen Benutzernamen und ein Passwort für die Installation ein:\n\t              <input name='username' class='text' type='text' placeholder='Neuer Benutzername' value=''>\n\t              <input name='password' class='text' type='password' placeholder='Neues Passwort' value=''>\n\t          </p>\n\t          ",
        buttons: {
            action: {
...
settings.setLogin = function() {
    var t = function(t) {
        var e = t.oldPassword || "",
            ...
            n = t.password || "";
        if (e.length < 1)
            return basicModal.error("oldPassword"), !1;
        if (i.length < 1)
            return basicModal.error("username"), !1;
        if (n.length < 1)
            return basicModal.error("password"), !1;
    ...
    basicModal.show({
        body: "\n\t          <p>\n\t              Aktuelles Passwort eingeben:\n\t              <input name='oldPassword' class='text' type='password' placeholder='Aktuelles Passwort' value=''>\n\t          </p>\n\t          <p>\n\t              Dein Benutzername und dein Passwort werden wie folgt geändert:\n\t              <input name='username' class='text' type='text' placeholder='Neuer Benutzername' value=''>\n\t              <input name='password' class='text' type='password' placeholder='Neues Passwort' value=''>\n\t          </p>\n\t          ",
        buttons: {
            action: {
                title: "Login ändern",
                fn: t
...
settings.setSorting = function() {
    var t = [],
        e = [],
        i = function() {
            e[0] = $(".basicModal select#settings_albums_type").val(),
            e[1] = $(".basicModal select#settings_albums_order").val(),
            t[0] = $(".basicModal select#settings_photos_type").val(),
            t[1] = $(".basicModal select#settings_photos_order").val(),
            basicModal.close(),
            albums.refresh();
            var i = {
                typeAlbums: e[0],
    ...
    basicModal.show({
        body: "\n\t          <p>\n\t              Album sortieren nach\n\t              <span class=\"select\">\n\t                  <select id='settings_albums_type'>\n\t                      <option value='id'>Erstellungszeit</option>\n\t                      <option value='title'>Titel</option>\n\t                      <option value='description'>Beschreibung</option>\n\t                      <option value='public'>Öffentlich</option>\n\t                  </select>\n\t              </span>\n\t              in an\n\t              <span class=\"select\">\n\t                  <select id='settings_albums_order'>\n\t                      <option value='ASC'>Aufsteigend</option>\n\t                      <option value='DESC'>Absteigend</option>\n\t                  </select>\n\t              </span>\n\t              order.\n\t          </p>\n\t          <p>\n\t              Fotos sortieren nach\n\t              <span class=\"select\">\n\t                  <select id='settings_photos_type'>\n\t                      <option value='id'>Upload-Zeit</option>\n\t                      <option value='takestamp'>Upload-Datum</option>\n\t                      <option value='title'>Titel</option>\n\t                      <option value='description'>Beschreibung</option>\n\t                      <option value='public'>Öffentlich</option>\n\t                      <option value='star'>Favoriten</option>\n\t                      <option value='type'>Foto Format</option>\n\t                  </select>\n\t              </span>\n\t              in an\n\t              <span class=\"select\">\n\t                  <select id='settings_photos_order'>\n\t                      <option value='ASC'>Aufsteigend</option>\n\t                      <option value='DESC'>Absteigend</option>\n\t                  </select>\n\t              </span>\n\t              order.\n\t          </p>\n\t          ",
        buttons: {
            action: {
    ...
    "" !== lychee.sortingAlbums && (e = lychee.sortingAlbums.replace("ORDER BY ", "").split(" "), $(".basicModal select#settings_albums_type").val(e[0]), $(".basicModal select#settings_albums_order").val(e[1])),
    "" !== lychee.sortingPhotos && (t = lychee.sortingPhotos.replace("ORDER BY ", "").split(" "), $(".basicModal select#settings_photos_type").val(t[0]), $(".basicModal select#settings_photos_order").val(t[1]))
},
settings.setDropboxKey = function(t) {
    var e = function(e) {
            var i = e.key;
            if (e.key.length < 1)
                return basicModal.error("key"), !1;
            basicModal.close(),
    ...
    var e = "",
        i = function(t) {
            ...
            return e += "\n\t\t         <div class='sidebar__divider'>\n\t\t             <h1>" + t.title + "</h1>\n\t\t         </div>\n\t\t         <table>\n\t\t         ", t.rows.forEach(function(t) {
                var i = t.value;
                "" !== i && null != i || (i = "-"),
                i = lychee.html(_templateObject36, t.title.toLowerCase(), i),
                !0 === t.editable && (i += " " + build.editIcon("edit_" + t.title.toLowerCase())),
                e += lychee.html(_templateObject37, t.title, i)
            }), e += "\n\t\t         </table>\n\t\t         "
        },
        n = function(t) {
            var e = "",
...
upload.notify = function(t, e) {
    if (null != e && "" !== e || (e = "You can now manage your new photo(s)."), !window.webkitNotifications)
        return !1;
...
upload.start = {
    local: function(t) {
            ...
            s = function t(s, o) {
                var a = new FormData,
                    ...
                    u = function() {
                        ...
                        $("#upload_files").val(""),
                        !1 === i && !1 === n ? (basicModal.close(), upload.notify("Upload complete")) : !1 === i && !0 === n ? ($(".basicModal #basicModal__action.hidden").show(), upload.notify("Upload complete")) : ($(".basicModal #basicModal__action.hidden").show(), upload.notify("Upload complete", "Failed to upload one or more photos.")),
                        albums.refresh(),
                        !1 === album.getID() ? lychee.goto("0") : album.load(e)
                    };
                a.append("function", "Photo::add"),
                a.append("albumID", e),
                a.append(0, o),
                r.open("POST", api.path),
                r.onload = function() {
                    var t = null,
                        e = !1,
                        a = "";
                    ...
                    200 === r.status && function(t) {
                        return !isNaN(parseFloat(t)) && isFinite(t)
                    }(t) ? $(".basicModal .rows .row:nth-child(" + (o.num + 1) + ") .status").html("Finished").addClass("success") : ("Error:" === t.substr(0, 6) ? (a = t.substr(6) + " Please take a look at the console of your browser for further details.", i = !0, $(".basicModal .rows .row:nth-child(" + (o.num + 1) + ") .status").html("Fehlgeschlagen").addClass("error"), !0 === i && lychee.error("Upload fehlgeschlagen. Der Server hat einen Fehler zurückgegeben!", r, t)) : "Warnung:" === t.substr(0, 8) ? (a = t.substr(8), n = !0, $(".basicModal .rows .row:nth-child(" + (o.num + 1) + ") .status").html("Übersprungen").addClass("warning"), !0 === i && lychee.error("Upload fehlgeschlagen. Der Server hat eine Warnung zurückgegeben!", r, t)) : (a = "Der Server hat eine unbekannte Antwort zurückgegeben. Bitte wirf einen Blick auf die Konsole deines Browsers für weitere Details.", i = !0, $(".basicModal .rows .row:nth-child(" + (o.num + 1) + ") .status").html("Fehlgeschlagen").addClass("error"), !0 === i && lychee.error("Upload fehlgeschlagen. Der Server hat einen unbekannten Fehler zurückgegeben!", r, t)), $(".basicModal .rows .row:nth-child(" + (o.num + 1) + ") p.notice").html(a).show());
                ...
                r.upload.onprogress = function(e) {
                    if (!0 !== e.lengthComputable)
                        return !1;
                    if (c = e.loaded / e.total * 100 | 0, c > l && ($(".basicModal .rows .row:nth-child(" + (o.num + 1) + ") .status").html(c + "%"), l = c), c >= 100 && !1 === h) {
                        var i = 0;
                        o.num + 1 > 4 && (i = 40 * (o.num + 1 - 4)),
                        $(".basicModal .rows").scrollTop(i),
                        $(".basicModal .rows .row:nth-child(" + (o.num + 1) + ") .status").html("Processing"),
                        null != o.next && (t(s, o.next), h = !0)
                    }
                },
                r.send(a)
            };
        ...
        for (var o = 0; o < t.length; o++)
            t[o].num = o,
            t[o].ready = !1,
            o < t.length - 1 ? t[o].next = t[o + 1] : t[o].next = null;
    ...
    url: function() {
        ...
        var i = function(t) {
            ...
            t.link && t.link.length > 3 ? (basicModal.close(), i[0] = {
                ...
                $(".basicModal .rows .row .status").html("importiere");
                var i = {
                    url: t.link,
                    albumID: e
                };
                api.post("Import::url", i, function(t) {
                    !0 !== t ? ($(".basicModal .rows .row p.notice").html("Der Import wurde abgeschlossen, aber es wurden Warnungen oder Fehler ausgegeben. Bitte wirf einen Blick auf das Protokoll (Einstellungen -> Protokoll anzeigen) für weitere Details.").show(), $(".basicModal .rows .row .status").html("Fertig").addClass("warning"), $(".basicModal #basicModal__action.hidden").show(), lychee.error(null, i, t)) : basicModal.close(),
        ...
        var e = function(e) {
            ...
            upload.show("Importing from server", i, function() {
                ...
                api.post("Import::server", i, function(e) {
                    if (albums.refresh(), upload.notify("Import vollständig"), "Hinweis: Nur enthaltene Alben importieren!" === e)
                        return visible.albums() ? lychee.load() : lychee.goto(), basicModal.close(), !0;
                    "Warnung: Ordner leer oder keine lesbaren Dateien zu verarbeiten!" === e ? ($(".basicModal .rows .row p.notice").html("Ordner leer oder keine lesbaren Dateien zu verarbeiten. Bitte wirft einen Blick auf das Protokoll (Einstellungen -> Protokoll anzeigen) für weitere Details.").show(), $(".basicModal .rows .row .status").html("Failed").addClass("error"), lychee.error("Der Import konnte nicht gestartet werden, weil der Ordner leer war!", i, e)) : !0 !== e ? ($(".basicModal .rows .row p.notice").html("Der Import wurde abgeschlossen, aber es wurden Warnungen oder Fehler ausgegeben. Bitte wirf einen Blick auf das Protokoll (Einstellungen -> Protokoll anzeigen) für weitere Details.").show(), $(".basicModal .rows .row .status").html("Fertig").addClass("warning"), lychee.error(null, i, e)) : basicModal.close(),
                    !1 === album.getID() ? lychee.goto("0") : album.load(t),
    ...
    dropbox: function() {
        ...
        var e = function(e) {
            ...
            upload.show("Importing from Dropbox", e, function() {
                ...
                api.post("Import::url", e, function(i) {
                    !0 !== i ? ($(".basicModal .rows .row p.notice").html("The import has been finished, but returned warnings or errors. Please take a look at the log (Settings -> Show Log) for further details.").show(), $(".basicModal .rows .row .status").html("Finished").addClass("warning"), $(".basicModal #basicModal__action.hidden").show(), lychee.error(null, e, i)) : basicModal.close(),
                    upload.notify("Import complete"),
                    albums.refresh(),
                    !1 === album.getID() ? lychee.goto("0") : album.load(t)
                })
...
view.albums = {
    ...
    content: {
        ...
        init: function() {
            var t = "",
                e = "";
            !1 === lychee.publicMode && (albums.parse(albums.json.smartalbums.unsorted), albums.parse(albums.json.smartalbums.public), albums.parse(albums.json.smartalbums.starred), albums.parse(albums.json.smartalbums.recent), t = build.divider("Smarte Album") + build.album(albums.json.smartalbums.unsorted) + build.album(albums.json.smartalbums.public) + build.album(albums.json.smartalbums.starred) + build.album(albums.json.smartalbums.recent)),
            albums.json.albums && 0 !== albums.json.num && ($.each(albums.json.albums, function() {
                albums.parse(this),
                e += build.album(this)
            }), !1 === lychee.publicMode && (e = build.divider("Alben") + e)),
            "" === t && "" === e ? (lychee.content.html(""), $("body").append(build.no_content("eye"))) : lychee.content.html(t + e),
            null != view.albums.content.scrollPosition && 0 !== view.albums.content.scrollPosition && $(document).scrollTop(view.albums.content.scrollPosition)
        },
        title: function(t) {
            var e = albums.getByID(t).title;
            e = lychee.escapeHTML(e),
            $('.album[data-id="' + t + '"] .overlay h1').html(e).attr("title", e)
        },
        delete: function(t) {
            $('.album[data-id="' + t + '"]').css("opacity", 0).animate({
                ...
                $(this).remove(),
                albums.json.num <= 0 && lychee.content.find(".divider:last-child").remove()
            })
        }
    }
},
view.album = {
    ...
    title: function() {
        if ((visible.album() || !album.json.init) && !visible.photo())
            switch (album.getID()) {
            case "f":
                lychee.setTitle("Favoriten", !1);
                break;
            case "s":
                lychee.setTitle("Öffentlich", !1);
                break;
            case "r":
                lychee.setTitle("Letzte", !1);
                break;
            case "0":
                lychee.setTitle("Unsortiert", !1);
                break;
            default:
                album.json.init && sidebar.changeAttr("title", album.json.title),
                lychee.setTitle(album.json.title, !0)
            }
    },
    content: {
        init: function() {
        ...
        title: function(t) {
            ...
            e = lychee.escapeHTML(e),
            $('.photo[data-id="' + t + '"] .overlay h1').html(e).attr("title", e)
        },
        star: function(t) {
        ...
        delete: function(t) {
            $('.photo[data-id="' + t + '"]').css("opacity", 0).animate({
                ...
                $(this).remove(),
                visible.albums() || (album.json.num--, view.album.num())
            })
        }
    },
    ...
    public: function() {
        "1" === album.json.public ? ($("#button_share_album").addClass("active").attr("title", "Album teilen"), $(".photo .iconic-share").remove(), album.json.init && sidebar.changeAttr("public", "Ja")) : ($("#button_share_album").removeClass("active").attr("title", "Veröffentlichen"), album.json.init && sidebar.changeAttr("public", "Nein"))
    },
    hidden: function() {
        "1" === album.json.visible ? sidebar.changeAttr("hidden", "Nein") : sidebar.changeAttr("hidden", "Ja")
    },
    downloadable: function() {
        "1" === album.json.downloadable ? sidebar.changeAttr("downloadable", "Ja") : sidebar.changeAttr("downloadable", "Nein")
    },
    password: function() {
        "1" === album.json.password ? sidebar.changeAttr("password", "Ja") : sidebar.changeAttr("password", "Nein")
    },
    sidebar: function(t) {
        function e() {
            return t.apply(this, arguments)
        ...
        if ((visible.album() || !album.json.init) && !visible.photo()) {
            var t = sidebar.createStructure.album(album.json),
                e = sidebar.render(t);
            sidebar.dom(".sidebar__wrapper").html(e),
            sidebar.bind()
        }
    })
},
view.photo = {
    ...
    title: function() {
        photo.json.init && sidebar.changeAttr("title", photo.json.title),
        lychee.setTitle(photo.json.title, !0)
    },
    description: function() {
        photo.json.init && sidebar.changeAttr("description", photo.json.description)
    },
    star: function() {
        "1" === photo.json.star ? $("#button_star").addClass("active").attr("title", "Nicht favorisieren") : ($("#button_star").removeClass("active"), $("#button_star").attr("title", "Favorisieren"))
    },
    public: function() {
        "1" === photo.json.public || "2" === photo.json.public ? ($("#button_share").addClass("active").attr("title", "Foto teilen"), photo.json.init && sidebar.changeAttr("public", "Ja")) : ($("#button_share").removeClass("active").attr("title", "Veröffentlichen"), photo.json.init && sidebar.changeAttr("public", "Nein"))
    },
    tags: function() {
        sidebar.changeAttr("tags", build.tags(photo.json.tags), !0),
        sidebar.bind()
    },
    photo: function(t) {
        function e() {
